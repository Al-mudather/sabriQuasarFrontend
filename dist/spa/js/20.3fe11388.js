...
`));var u=i("2f62"),m={data(){return{r_code:null,visible:!1}},computed:a()({},Object(u["d"])("pyramidManagement",["registerationCode"])),beforeDestroy(){this.SET_REGISTERATION_CODE_ACTION("")},mounted(){this.$q.notify({type:"warning",progress:!0,multiLine:!0,position:"top",message:this.$t("قم بإدخال كود التسجيل")}),this.registerationCode.length>4&&(this.r_code=this.registerationCode,this.REGISTER_THE_USER_WITH_REGISTERATION_CODE())},methods:a()(a()({},Object(u["b"])("pyramidManagement",["SET_REGISTERATION_CODE_ACTION"])),{},{async REGISTER_THE_USER_WITH_REGISTERATION_CODE(t){if(t&&t.preventDefault(),this.r_code)try{this.visible=!0;const t=await this.$apollo.mutate({mutation:p,variables:{marketingCode:this.r_code,input:{}}});this.visible=!1,t.data.joinPlatform.success&&(this.$q.notify({type:"positive",progress:!0,multiLine:!0,position:"top",message:this.$t("مرحبا بك")}),this.SET_REGISTERATION_CODE_ACTION(""),this.GO_TO_HOME_PAGE())}catch(e){"GraphQL error: Pyramid matching query does not exist."==e.message&&(this.$q.notify({type:"negative",progress:!0,multiLine:!0,position:"top",message:this.$t("هذا الكود خاطئ ادخل الكود الصحيح")}),this.$router.push({name:"registeration-code"})),this.visible=!1}else this.$q.notify({type:"negative",position:"top",progress:!0,multiLine:!0,message:"You must enter the registeration code"})},GO_TO_HOME_PAGE(){this.$router.push({name:"Home"})},errorHandler(t){for(const e in t)for(const i of t[e])this.$q.notify({type:"warning",progress:!0,multiLine:!0,position:"top",message:i.message})}})},g=m,h=(i("b237"),i("2877")),_=i("27f9"),f=i("74f7"),E=i("9149"),T=i("8572"),b=i("eebe"),I=i.n(b),O=Object(h["a"])(g,s,n,!1,null,null,null);e["default"]=O.exports;I()(O,"components",{QInput:_["a"],QInnerLoading:f["a"],QSpinnerHourglass:E["a"],QField:T["a"]})},b237:function(t,e,i){"use strict";i("e823")},e823:function(t,e,i){}}]);
...
`));var y=s("2f62"),v={name:"Notification",data(){return{myNotifications:"",loading:!1,notificationData:[]}},apollo:{myNotifications:{query:g,variables:{orderBy:["-id"],limit:2},result(t){this.loading=t.loading,t.loading||(this.notificationData=t.data.myNotifications)}}},components:{NotificationCard:h},mounted(){this.setActiveNavAction("NOTIFICATION")},computed:{GET_NOTIFICATION_DATA(){return this.notificationData}},methods:n()(n()({},Object(y["b"])("settings",["setActiveNavAction"])),{},{async LOAD_MORE_DATA(){await this.$apollo.queries.myNotifications.fetchMore({variables:{cursor:this.myNotifications.pageInfo.endCursor},updateQuery:(t,{fetchMoreResult:i})=>{const s=i.myNotifications.edges,a=i.myNotifications.pageInfo;return s.length?(this.myNotifications={__typename:t.myNotifications.__typename,edges:[...t.myNotifications.edges,...s],pageInfo:a},{myNotifications:this.myNotifications}):t}})}})},C=v,I=(s("b371"),s("293e")),T=s("eebe"),A=s.n(T),O=Object(f["a"])(C,a,e,!1,null,null,null);i["default"]=O.exports;A()(O,"components",{QSkeleton:I["a"]})},b371:function(t,i,s){"use strict";s("e4de")},e4de:function(t,i,s){}}]);
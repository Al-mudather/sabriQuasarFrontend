            ...
            <div class="container">
              <div class="cn fadeIn row justify-center">
                <div
                  ...
                  :key="course.node.id"
                  class="col-lg-3 col-md-5 col-sm-5 col-xs-12"
                >
                  <course-card
                    :course="course.node"
...
export default {
  ...
  updated() {
    if (this.counter === 0) {
      ...
      this.$refs.cat.firstChild.firstChild.firstChild.firstChild.classList.add(
        "active"
      );
      const specialityId = JSON.parse(
        this.$refs.cat.firstChild.firstChild.firstChild.firstChild.dataset
          .course
      );

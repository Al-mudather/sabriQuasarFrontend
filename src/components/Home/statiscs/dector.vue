<template>
    <div class="dector">
        <svg class="svdec" xmlns="http://www.w3.org/2000/svg" width="135.549"
            height="64.583" viewBox="0 0 135.549 64.583">
            <g id="Group_200" data-name="Group 200"
                ...
                <path id="Path_484" data-name="Path 484"
                    ...
                    transform="translate(96.22 3.838)" fill="#e9ebf6" fill-rule="evenodd" />
                <path id="Path_485" data-name="Path 485"
                    ...
                    transform="translate(69.043 12.411)" fill="#e9ebf6"
                    fill-rule="evenodd" />
                <path id="Path_486" data-name="Path 486"
                    ...
                    transform="translate(0)" fill="#e9ebf6" fill-rule="evenodd" />
            </g>
        </svg>
        <div class="dec">

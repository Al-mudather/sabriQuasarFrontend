<template>
    <div class="all">
        ...
        <p>
            جميعنا يعلم أن المواد الغذائية المختلفة تعتبر ضرورية لنمو الإنسان، و
            لقيامه بمختلف النشاطات اليومية. و لكن هل تتوقف فوائد الغذاء هنا أو
            تتعداها لتصبح طريقة وقاية أو علاج من العديد من الأمراض المزمنة؟ و ما
            علاقة الغذاء بظهور بعض الأمراض المزمنة من خلال التأثير في الكائنات
            الحية الدقيقة التي تعيش في أمعائنا؟ إمكانية توفير الغذاء في حالات
            الحروب و الكوارث تعتبر مشكلة حقيقية تهدد حياة الإنسان، فما هي
            الأخطار الصحية التي تظهر في مثل هذه الحالات؟ و ما هي الأغذية الداعمة
            المتوفرة لتجنبها؟ سوف نحاول من خلال وحدات هذا
        </p>
    </div>
</template>

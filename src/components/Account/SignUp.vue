        ...
        <a @click="RegisterNewUser" style="cursor: pointer">
          <svg class="nexx" xmlns="http://www.w3.org/2000/svg" width="61.667" height="54" viewBox="0 0 61.667 54">
            <g id="Group_363" data-name="Group 363" transform="translate(0 54)">
              <path id="Path_55" data-name="Path 595"
                    ...
                    fill="#fbc74b" fill-rule="evenodd"/>
              <path id="Path_56" data-name="Path 596"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loginAuthMutation(access_token, provider) {
      ...
      helloGoogleAuth(network = 'google') {
        ...
        //
        //   console.log("Login Was Successful", network, authResponse.access_token)
        //
        //   this.$apollo.mutate({
        //     mutation: SocialAuth,
        //     variables: {
        //       provider: `${network}-oauth2`,
        ...
        hello('google').login({
          ...
          this.loginAuthMutation(google.access_token, `google-oauth2`)

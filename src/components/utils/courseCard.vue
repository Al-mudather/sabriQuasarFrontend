<template>
    <div class="card q-mb-lg">
      ...
      <div class="card-body">
        ...
        <button v-if="!openCourse" @click=" $router.push( { name: 'course-details', params: { pk: course.pk, id: course.id } } ) " class="details"> {{$t('التفاصيل')}} <img src="~assets/img/leftArraw.png" alt=""></button>                                                
      </div>
    </div>

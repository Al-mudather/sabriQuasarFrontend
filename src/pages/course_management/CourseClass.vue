            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="15.103" height="9.192" viewBox="0 0 15.103 9.192">
                            <path id="Path_998" data-name="Path 998" d="M8447.5,1553.75s.75,7.625,5.25,5.875,7.125-2.75,8.875,3.125" transform="translate(-8447.002 -1553.701)" fill="none" stroke="#fcd462" stroke-width="1"/>
                        </svg>  
                        <div class="progress">                            
                            <div class="progress-bar" role="progressbar" :style="{ width: calculateTheTotalProgress + '%' }" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div> 
                <!-- start tab lec -->
  ...
  methods: {
    ...
    async START_LEARNING_UNIT_TRAKING() {
        if (this.$_.isEmpty(this.startLearningTrackingID)) {
            ...
            const startLearningTrackingID = await this.START_LEARNING_UNIT_TRAKING_ACTION(this.progressData)
            //TODO: Set the learning tracking id
            this.SET_START_LEARNING_TRACKING_ID_ACTION(startLearningTrackingID)  
        }
    },
    ...
    async END_LEARNING_UNIT_TRAKING() {
      if (this.startLearningTrackingID) {
          ...
          const res_endTrackingResult = await this.END_LEARNING_UNIT_TRAKING_ACTION(ending_data)
          if (res_endTrackingResult) {
    ...
    async GOT_TO_THE_NEXT_LESSON() {
        // this.player.setVideoUrl(this.viomURL)
        // TODO: End the learning tracker video
        this.END_LEARNING_UNIT_TRAKING()
        //TODO: Set the learning tracking id
      ...
      handler: function(route) {
        ...
        this.$apollo
          ...
          .then(res => {
            ...
            this.progressData.courseId = res.data.course.pk
            ...
            if (res.data.course.pk) {
              ...
              this.$apollo
                ...
                .then(res => {
                  ...
                  if (enrollmentID) {
                    this.progressData.enrollmentId = enrollmentID

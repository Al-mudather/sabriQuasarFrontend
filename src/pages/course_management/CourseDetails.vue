...
// titleSlug is now provided by the shared util; imported above as courseSlug.
// Keeping this local alias so the two call sites below read naturally.
const titleSlug = courseSlug

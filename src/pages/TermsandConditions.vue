            ...
            <div class="Conditions"> 
              ...
              <p class="condP">
                {{ 
                  ...
                  ` 
                  : 
                  'يرجى قراءة الشروط التاليه جيدا قبل إستخدامك للمنصه التعليميه. حيش إستخدامك لها يعني قبولك لهذه الشروط و موافقتك على الإلتزام بها. في حالة عدم موافقتك يرجى عدم إستخدام المنصه.'
                }}
              </p>
            </div>

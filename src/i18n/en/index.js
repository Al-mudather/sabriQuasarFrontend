...
export default {
  ...
  "_comment_src_components_Home_Statiscs.vue": "src_components_Home_Statiscs.vue",
      ...
      "طالب و طالبه" : "A student and a student",
 
      "دكتور متخصص" : "Specialist Doctor",
 
      "دوره تدريبيه" : "Training course",
 
      "عدد الساعات التدريبيه" : "The number of training hours",
  ...
  "_comment_src_components_Home_Training copy.vue": "src_components_Home_Training copy.vue",
  ...
  "_comment_src_pages_course_management_CourseDetails.vue": "src_pages_course_management_CourseDetails.vue",
      ...
      "extColor;                        margin: 0;                        span{                            color: $yalloColor;                        }                    }                    p{                        font-size: 15px;                        margin: 0;                        color: extColor;                        font-family: cairoR;                    }                    img{                        width: auto;                        margin: -6px 0 0 0 ;                    }                }            }            .more{                position: relative;                width: 250px;                height: 167px;                margin: 0 auto;                svg{                    position: absolute;                    top: 0;                    width: 100%;                    left: 0;                    text-align: center;                }                .pric{                    position: relative;                    top: 36px;                    text-align: center;                    h3{                        color: #F3ECAA;                        font-size: 24px;                        font-family: cairoR;                        margin: 0 0 7px 0;                        span{                            font-size: 13px;                            color: #F2F2F2;                            margin-left: 10px;                        }                    }                    button{                        background-color: $yalloColor;                        color: extColor;                        outline: 0;                        height: 40px;                        width: 105px;                    }                }                .share{                    position: absolute;                    top: 102px;                    right: 16px;                    width: auto;                    cursor: pointer;                }                .addCou{                    position: absolute;                    top: 100px;                    left: 16px;                    width: auto;                    cursor: pointer;                }            }        }    }    /*-- detailes --*/    .detailes{        padding: 10px;        border-right: 7px solid #F6F6F6;        //maxMobile        @mediamax-width:767px" : "extColor; margin: 0; span {color: $ yalloColor; }} p {font-size: 15px; margin: 0; color: extColor; font-family: cairoR; } img {width: auto; margin: -6px 0 0 0; }}} .more {position: relative; width: 250px; height: 167px; margin: 0 auto; svg {position: absolute; top: 0; width: 100%; left: 0; text-align: center; } .pric {position: relative; top: 36px; text-align: center; h3 {color: # F3ECAA; font-size: 24px; font-family: cairoR; margin: 0 0 7px 0; span {font-size: 13px; color: # F2F2F2; margin-left: 10px; }} button {background-color: $ yalloColor; color: extColor; outline: 0; height: 40px; width: 105px; }} .share {position: absolute; top: 102px; right: 16px; width: auto; cursor: pointer; } .addCou {position: absolute; top: 100px; left: 16px; width: auto; cursor: pointer; }}}} / * - detailes - * / .detailes {padding: 10px; border-right: 7px solid # F6F6F6; // maxMobile @ mediamax-width: 767px",
 
      "extColor;                    font-size: 18px;                    font-family: cairoR;                    display: inline-block;                    margin: 17px 55px 0 0;                }            }            p{               color: #9C9C9C;               font-size: 16px;               font-family: cairoR;                 line-height: 1.7;                  width: 90%;               margin-right: 39px;            }            .pluse{                margin: 0 50px 17px 0;                //maxMobile                @mediamax-width:767px" : "extColor; font-size: 18px; font-family: cairoR; display: inline-block; margin: 17px 55px 0 0; }} p {color: # 9C9C9C; font-size: 16px; font-family: cairoR; line-height: 1.7; width: 90%; margin-right: 39px; } .pluse {margin: 0 50px 17px 0; // maxMobile @ mediamax-width: 767px",
